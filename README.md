...
<script>
// Shift pattern & Poya days
const workPattern = ['Day','Day','Night','Night','Off','Off','Off'];
const poyaDates = ['2026-04-05','2026-04-19','2026-05-04']; // Example Poya dates YYYY-MM-DD
let shifts = [];
...
function getShift(dateIndex){ return workPattern[dateIndex % workPattern.length]; }
...
function generateReport(){
    let reportWindow = window.open("", "Monthly Report", "width=800,height=600");
